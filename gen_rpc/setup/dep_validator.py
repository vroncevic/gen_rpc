...
Info
    Validator for the gen_rpc bundle dependencies.
'''
...
class GenRPCBundleDependenciesValidator:
    '''
        Validator for the gen_rpc bundle dependencies.
        ...
        It defines:
            ...
            :methods:
                | validate - Validates the gen_rpc bundle dependencies.
                | is_valid - Checks if the gen_rpc bundle dependencies is valid.
    '''

    @classmethod
    def validate(cls, dependencies: GenRPCBundleDependencies) -> None:
        '''
            Validates the gen_rpc bundle dependencies.

            :param dependencies: The gen_rpc bundle dependencies to be validated.
            :exceptions:
        ...
        '''
        ctx: str = 'gen_rpc_bundle_dependencies_validator::validate(...)'
        msg_dependencies_none: str = 'the gen_rpc bundle dependencies must be provided'
        msg_dependencies_istype: str = 'the gen_rpc bundle dependencies must be a Mapping'

        not_none(dependencies, ctx, msg_dependencies_none)
        istype(dependencies, Mapping, ctx, msg_dependencies_istype)

        for attr_name, expected_type in GenRPCBundleKeys.get_dependency_to_type().items():
    ...
    @classmethod
    def is_valid(cls, genrpcbundledependencies: GenRPCBundleDependencies) -> bool:
        '''
            Checks if the genrpcbundledependencies is valid.

            :param genrpcbundledependencies: The genrpcbundledependencies to be checked.
            :return: True if valid, False otherwise.
        '''
        try:
            cls.validate(genrpcbundledependencies)
            return True
