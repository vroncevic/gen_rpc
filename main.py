...
def main() -> bool:
    '''
        Bootstraps and runs the gen_rpc with required adapters.

        :return: True if successful, False otherwise.
        :exceptions: None
    '''
    gen_rpc: GenRPC = GenRPC(GenRPCBundleFactory.create_bundle())

    return gen_rpc.process()


if __name__ == '__main__':
    '''
        Entry point for gen_rpc execution.
