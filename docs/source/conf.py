...
version: str = '1.0.3'
release: str = 'https://github.com/vroncevic/gen_rpc/releases'
...
htmlhelp_basename: str = 'gen_rpcdoc'
latex_elements: Dict[Any, Any] = {}
latex_documents: List[Tuple[Any, ...]] = [(
    master_doc, 'gen_rpc.tex', 'gen\\_autoconf Documentation',
    'Vladimir Roncevic \\textless{}elektron.ronca@gmail.com\\textgreater{}',
    'manual'
)]
man_pages: List[Tuple[Any, ...]] = [(
    master_doc, 'gen_rpc', 'gen_rpc Documentation', [author], 1
)]
texinfo_documents: List[Tuple[Any, ...]] = [(
    master_doc, 'gen_rpc', 'gen_rpc Documentation', author,
    'gen_rpc', 'One line description of project.', 'Miscellaneous'
)]
