...
Info
    A validator for the gen_rpc bundle.
'''
...
class GenRPCBundleValidator:
    ...
    @classmethod
    def validate(cls, bundle: GenRPCBundle) -> None:
        '''
            Validates the gen_rpc bundle.

            :param bundle: The gen_rpc bundle to be validated.
            :exceptions:
        ...
        '''
        ctx: str = 'gen_rpc_bundle_validator::validate(...)'
        msg_bundle_none: str = 'the gen_rpc bundle must be provided'
        msg_bundle_istype: str = 'the gen_rpc bundle must be an instance of GenRPCBundle'
        ...
        istype(bundle, GenRPCBundle, ctx, msg_bundle_istype)
