...
Info
    Defines class GenRPC with attribute(s) and method(s).
...
try:
    ...
    from gen_rpc.pro import GenPro
...
class GenRPC(ATSCli):
    '''
        ...
        It defines:
            ...
            :methods:
                | __init__ - Initials GenRPC constructor.
                | process - Processes and runs tool operations.
    '''

    _GEN_VERBOSE: str = 'GEN_RPC'
    _CONFIG: str = '/conf/gen_rpc.cfg'
    _LOG: str = '/log/gen_rpc.log'
    _LOGO: str = '/conf/gen_rpc.logo'
    _OPS: List[str] = ['-n', '--name', '-v', '--verbose']

    def __init__(self, verbose: bool = False) -> None:
        '''
            Initials GenRPC constructor.
        ...
        gen_rpc_property: Dict[str, str | bool] = {
        ...
        Splash(gen_rpc_property, verbose)
