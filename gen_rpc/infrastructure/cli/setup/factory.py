...
from gen_rpc.infrastructure.cli.setup.opt_validator import CLIBundleOptionsValidator
from gen_rpc.infrastructure.cli.setup.bundle import CLIBundle
from gen_rpc.infrastructure.cli.setup.keys import CLIBundleKeys
...
from gen_rpc.infrastructure.command.icommand_executor import ICommandExecutor
...
class CLIBundleFactory:
    ...
    def create_bundle(cls, options: CLIBundleOptions) -> CLIBundle:
        ...
        service_definition: ICommandDefinition = GenRPCCommandDefinition()
        service_executor: ICommandExecutor = GenRPCCommandExecutor(definition=service_definition)
