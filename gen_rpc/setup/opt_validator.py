...
Info
    Validator for the gen_rpc bundle options.
'''
...
class GenRPCBundleOptionsValidator:
    '''
        Validator for the gen_rpc bundle options.
    ...
    @classmethod
    def validate(cls, options: GenRPCBundleOptions) -> None:
        '''
            Validates the gen_rpc bundle options.

            :param options: The gen_rpc bundle options to be validated.
            :exceptions:
        ...
        '''
        ctx: str = 'gen_rpc_bundle_options_validator::validate(...)'
        msg_options_none: str = 'the gen_rpc bundle options must be provided'
        msg_options_istype: str = 'the gen_rpc bundle options must be a Mapping'

        not_none(options, ctx, msg_options_none)
        istype(options, Mapping, ctx, msg_options_istype)

        for attr_name, expected_type in GenRPCBundleKeys.get_option_to_type().items():
